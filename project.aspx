            ...
            <div class="row">
                <div class="col-lg-auto col-12">
                    <div class="form-group ">
                        <a id="btnAdd" class="btn btn-success" href="project_edit.aspx">
                ...
                <div id="divSearch" class="col">
                    <div class="form-row justify-content-end">
                        ...
                        <div class="col-auto">
                            <div class="form-group">
                                <asp:DropDownList ID="ddlDimension" runat="server" CssClass="form-control" disabled="true">
                                </asp:DropDownList>
                            </div>
                        </div>
                        ...
                        <div class="col-auto">
                            <div class="form-group">
                                <asp:DropDownList ID="ddlStatus" runat="server" CssClass="form-control">
                                    <asp:ListItem Value="2019" Text="- สถานะ -"></asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphScript" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function CreateDataRow(objData, nRowNo) {
            var sHTML = "";
            var isCanDel = (objData.IsAdmin || objData.IsOwner) && $Permission == "A" && (objData.nStatusID == 0 || objData.nStatusID == 4) && !objData.IsPassApprove && !IsApprover;
        ...
        '<label for="cbRec_' + objData.nProjectID + '">' + nRowNo + '.</label></div>') : nRowNo + '.') + '</td>';
            ...
            sHTML += '<td class="text-center" valign="top">' +
                    '<a class="btn btn-sm btn-outline-info"  href="' + sPageEdit + '?str=' + objData.sIDEncrypt + '" title="' + objData.sButtonAction + '">' +
                    '<i class="fa fa-' + (objData.sButtonAction == "แก้ไข" ? "edit" : (objData.sButtonAction == "อนุมัติ" ? "check" : "eye")) + '"></i>&nbsp;' +
                    '</a>' +
                    '</td>';
